...
export interface ApiCategorieCategorie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    category: Schema.Attribute.String;
    cover_categories: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTipsAndStoryTipsAndStory
  extends Struct.CollectionTypeSchema {
  collectionName: 'tips_and_stories';
  info: {
    displayName: 'tips and story';
    pluralName: 'tips-and-stories';
    singularName: 'tips-and-story';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tips-and-story.tips-and-story'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tips-and-story.tips-and-story': ApiTipsAndStoryTipsAndStory;
